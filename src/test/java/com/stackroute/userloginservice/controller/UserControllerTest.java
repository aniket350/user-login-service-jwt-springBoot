...
//        User user1=userRepository.findByEmailIdAndPassword("satyam@gmail.com","satyam");
//        Assert.assertEquals("satyam@gmail.com",user1.getEmailId());
//        Assert.assertEquals("satyam",user1.getPassword());
//    }
//
////    @Test
